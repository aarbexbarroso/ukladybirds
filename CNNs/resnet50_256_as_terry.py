...
from tensorflow.keras.layers import GlobalAveragePooling2D, Dense, Dropout, GlobalMaxPooling2D, BatchNormalization
...
CSV_OUTPUT_DIR = "./csv_10/Resnet50_256_drop03/Batch"+str(RUN)
OUTPUT_DIR = "./Resnet50_256_drop03"
...
# Função de pré-processamento (ResNet)
...
# Salvar modelo
model.save('resnet50_256_drop03_final_batch_'+str(RUN)+'.h5')
print("\nModelo salvo como 'resnet50_256_drop03_final_batch_'+str(RUN)+'.h5'")
